...
class CouponListWidget extends StatefulWidget {
  ...
  static String routeName = 'coupon_list';
  static String routePath = '/coupon_list';
...
class _CouponListWidgetState extends State<CouponListWidget>
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.coupons = await queryCouponsRecordOnce(
        parent: currentUserReference,
        queryBuilder: (couponsRecord) => couponsRecord.orderBy('expires_at'),
      );
                            ...
                            child: TabBarView(
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Builder(
                                    builder: (context) {
                                      final mycoupons = _model.coupons
                                              ?.where((e) =>
                                                  (e.isUsed == false) &&
                                                  (e.expiresAt! >=
                                                      getCurrentTimestamp))
                                      ...
                                      return Column(
                                        ...
                                        children: List.generate(
                                            mycoupons.length, (mycouponsIndex) {
                                          final mycouponsItem =
                                              mycoupons[mycouponsIndex];
                                          return Container(
                                                        ...
                                                        Column(
                                                          ...
                                                          children: [
                                                            ...
                                                            Row(
                                                              ...
                                                              children: [
                                                                Text(
                                                                  functions.hourAndMinute(mycouponsItem
                                                                              .usedAt !=
                                                                          null
                                                                      ? mycouponsItem
                                                                          .usedAt
