...
class _AddAddressWidgetState extends State<AddAddressWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.defaultAddressCheck = await queryAddressesRecordOnce(
      ...
      _model.isDefaultAddress =
          (_model.defaultAddressCheck?.isDefault == null) ||
                  (_model.defaultAddressCheck?.isDefault == false)
              ? true
              : false;
      safeSetState(() {});
        ...
        body: SafeArea(
          ...
          child: Align(
            ...
            child: Container(
              ...
              child: Visibility(
                visible: _model.isDefaultAddress != null,
                child: Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Row(
                              mainAxisSize: MainAxisSize.max,
                              children: [
                                if (_model.isDefaultAddress != null)
                                  Theme(
                                    data: ThemeData(
                                    ...
                                    child: Checkbox(
                                      ...
                                      onChanged: (newValue) async {
                                        ...
                                        if (newValue!) {
                                          _model.isDefaultAddress = true;
                                          safeSetState(() {});
                                        } else {
                                          _model.isDefaultAddress = false;
                                          safeSetState(() {});
                                        }
                                      },
                    ...
                    Padding(
                      ...
                      child: FFButtonWidget(
                        onPressed: () async {
                          ...
                          if ((_model.defaultAddressCheck?.isDefault == true) &&
                              (_model.isDefaultAddress == true)) {
                            await _model.defaultAddressCheck!.reference
                                .update(createAddressesRecordData(
                              isDefault: false,
                            ));
                          }

                          await AddressesRecord.createDoc(currentUserReference!)
                              .set(createAddressesRecordData(
                            address: widget.address,
                            detailAddress: _model.textController3.text,
                            isDefault: _model.isDefaultAddress,
                          ...
                          context.goNamed(AddressWidget.routeName);
                        },
