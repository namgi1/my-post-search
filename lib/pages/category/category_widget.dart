...
class _CategoryWidgetState extends State<CategoryWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      _model.mainCategory = FFLocalizations.of(context).getVariableText(
        koText: '육류·생선',
        enText: 'Meat',
        idText: 'Daging',
        bnText: 'মাংস',
                              ...
                              child: Builder(
                                builder: (context) {
                                  ...
                                  return ListView.builder(
                                    ...
                                    itemBuilder: (context, maincategoryIndex) {
